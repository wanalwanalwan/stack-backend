...
insert into public.users (id, dupr_id, dupr_rating, username, avatar_url, location) values
  ('a1111111-1111-1111-1111-111111111111', 'DUPR-1001', 3.75, 'alice_pickle',  null, extensions.st_setsrid(extensions.st_makepoint(-97.7431, 30.2672), 4326)::extensions.geography),
  ('b2222222-2222-2222-2222-222222222222', 'DUPR-1002', 4.20, 'bob_dinks',     null, extensions.st_setsrid(extensions.st_makepoint(-97.7500, 30.2700), 4326)::extensions.geography),
  ('c3333333-3333-3333-3333-333333333333', 'DUPR-1003', 3.50, 'carol_smash',   null, extensions.st_setsrid(extensions.st_makepoint(-96.7970, 32.7767), 4326)::extensions.geography);
